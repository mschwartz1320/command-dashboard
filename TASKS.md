...
- **Prep for Alpine screening call Tue Apr 28 11:30am** <!-- estimate:30m --> <!-- tag:job --> <!-- ai:medium -->
  - Juliette Callam, confirmed via Calendly. Research Alpine before call. Resume already forwarded.
- **Prep for Red Ventures call Tue Apr 28 1pm** <!-- estimate:15m --> <!-- tag:job --> <!-- ai:low -->
  - Lauren Hasell, phone screen.
- **Prep for ARInsights PM Phone Screen Wed Apr 29 2:30pm** <!-- estimate:30m --> <!-- tag:job --> <!-- ai:medium -->
  - Kelsey Warren (Higher People), phone call. New opportunity, not previously on board.
